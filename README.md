...
<div align="center">
 <img src="assets/Magallanes.svg" alt="Magallanes">
</div>

---

A **Junior Software Developer** with a strong foundation in Python, focused on building practical, efficient, and well-structured software. 
I have experience in database design and developing custom libraries, with particular interest in solving problems using well-documented software prioritizing **UX**.

Also I have experience in game development using Pygame and Arcade, applying concepts of graphics, logic design, and system structure. Comfortable working across different abstraction levels, from high-level application logic to more low-level control when needed.

- 🌍 Based in Ciudad Juárez, Chihuahua, México
...
<table>
  ...
  <tr>
    ...
    <td>
      ...
      <img src="assets/XAMPP.ico" height="40" title="XAMPP"/>
      <img src="https://upload.wikimedia.org/wikipedia/commons/4/4b/Codeblocks_logo.png" height="40" title="Code::Blocks"/>
    </td>
  </tr>
</table>
</div>
